...
print(
    "F1-Score with llama 7b (8 shot CoT): ",
    f1_score(ground_truth, llama_7b_label),
)
print(
    "Precision with llama 7b (8 shot CoT): ",
    precision_score(ground_truth, llama_7b_label),
)
print(
    "Recall with llama 7b (8 shot CoT): ",
    recall_score(ground_truth, llama_7b_label),
)
print(
    "Accuracy with llama 7b (8 shot CoT): ",
...
print(
    "F1-Score with zephyr beta (8 shot CoT): ",
    f1_score(ground_truth, zephyr_label),
)
print(
    "Precision with zephyr beta (8 shot CoT): ",
    precision_score(ground_truth, zephyr_label),
)
print(
    "Recall with zephyr beta (8 shot CoT): ",
    recall_score(ground_truth, zephyr_label),
)
print(
    "Accuracy with zephyr beta (8 shot CoT): ",
