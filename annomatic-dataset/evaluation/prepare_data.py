...
# %%
train_df, devtest_df = train_test_split(df, test_size=0.3, stratify=df.source_party,random_state=42)
dev_df, test_df = train_test_split(
    devtest_df, test_size=0.5, stratify=devtest_df.source_party,random_state=42
)
...
print("\nLeft")
print(train_df[train_df['source_party']=='Left'].label.value_counts(normalize=True))
print(dev_df[dev_df['source_party']=='Left'].label.value_counts(normalize=True))
print(test_df[test_df['source_party']=='Left'].label.value_counts(normalize=True))

print("\nRight")
print(train_df[train_df['source_party']=='Right'].label.value_counts(normalize=True))
print(dev_df[dev_df['source_party']=='Right'].label.value_counts(normalize=True))
print(test_df[test_df['source_party']=='Right'].label.value_counts(normalize=True))

# %%
print("Per source label distribution")

print("\nLeft")
print(train_df[train_df['source_name']=='alternet'].label.value_counts(normalize=True))
print(dev_df[dev_df['source_name']=='alternet'].label.value_counts(normalize=True))
print(test_df[test_df['source_name']=='alternet'].label.value_counts(normalize=True))
# %%
