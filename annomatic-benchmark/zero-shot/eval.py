...
print(
    "F1-Score with Falcon 7b with (0 shot): ",
    f1_score(ground_truth, falcon_7b_label),
)
print(
    "Precision with Falcon 7b with (0 shot): ",
    precision_score(ground_truth, falcon_7b_label),
)
print(
    "Recall with Falcon 7b with (0 shot): ",
    recall_score(ground_truth, falcon_7b_label),
)
print(
    "Accuracy with Falcon 7b with (0 shot): ",
...
print(
    "F1-Score with Flan T5 Large (0 shot): ",
    f1_score(ground_truth, flan_t5_large_label),
)
print(
    "Precision with Flan T5 Large (0 shot): ",
    precision_score(ground_truth, flan_t5_large_label),
)
print(
    "Recall with Flan T5 Large (0 shot): ",
    recall_score(ground_truth, flan_t5_large_label),
)
print(
    "Accuracy with Flan T5 Large (0 shot): ",
...
print(
    "Recall with Flan UL2 (0 shot): ",
    recall_score(ground_truth, flan_ul2_label),
)
print(
    "Accuracy with Flan UL2 (0 shot): ",
...
print(
    "F1-Score with GPT 4 turbo with (0 shot): ",
    f1_score(ground_truth, gpt_4_label),
)
print(
    "Precision with GPT 4 turbo with (0 shot): ",
    precision_score(ground_truth, gpt_4_label),
)
print(
    "Recall with GPT 4 turbo with (0 shot ): ",
    recall_score(ground_truth, gpt_4_label),
)
print(
    "Accuracy with GPT 4 turbo with (0 shot): ",
...
print(
    "Recall with llama 7b (0 shot): ",
    recall_score(ground_truth, llama_7b_label),
)
print(
    "Accuracy with llama 7b (0 shot): ",
...
print(
    "F1-Score with Llama 2 13b with (0 shot): ",
    f1_score(ground_truth, llama_13b_label),
)
print(
    "Precision with Llama 2 13b with (0 shot): ",
    precision_score(ground_truth, llama_13b_label),
)
print(
    "Recall with Llama 2 13b with (0 shot): ",
    recall_score(ground_truth, llama_13b_label),
)
print(
    "Accuracy with Llama 2 13b with (0 shot): ",
...
print(
    "F1-Score with Mistral-7B-Instruct-v0.1 with (0 shot): ",
    f1_score(ground_truth, df_mistral_7b_label),
)
print(
    "Precision with Mistral-7B-Instruct-v0.1 with (0 shot): ",
    precision_score(ground_truth, df_mistral_7b_label),
)
print(
    "Recall with Mistral-7B-Instruct-v0.1 with (0 shot): ",
    recall_score(ground_truth, df_mistral_7b_label),
)
print(
    "Accuracy with Mistral-7B-Instruct-v0.1 with (0 shot): ",
...
def update_label(row):
    if row["response"].startswith("BIASED") and row["label"] == "?":
        ...
        return "NOT BIASED"
    elif row["response"].startswith("BIAS-FREE") and row["label"] == "?":
        return "NOT BIASED"
    elif (
        row["response"].startswith("BIAS: The sentence above is biased")
        and row["label"] == "?"
    ):
        return "BIASED"
    elif (
        row["response"].startswith("BIAS: The sentence contains bias")
        and row["label"] == "?"
    ):
        return "BIASED"
    elif (
        ...
        row["response"].startswith("BIAS cannot be determined from the")
        and row["label"] == "?"
    ):
        return "!"
    else:
...
print(
    "F1-Score with mixtral_8x7b with (0 shot): ",
    f1_score(ground_truth, df_mixtral_8x7b_label),
)
print(
    "Precision with mixtral_8x7b with (0 shot): ",
    precision_score(ground_truth, df_mixtral_8x7b_label),
)
print(
    "Recall with mixtral_8x7b with (0 shot): ",
    recall_score(ground_truth, df_mixtral_8x7b_label),
)
print(
    "Accuracy with mixtral_8x7b with (0 shot): ",
...
print(
    "F1-Score with OpenChat 3.5 with (0 shot): ",
    f1_score(ground_truth, openchat_label),
)
print(
    "Precision with OpenChat 3.5 with (0 shot): ",
    precision_score(ground_truth, openchat_label),
)
print(
    "Recall with OpenChat 3.5 with (0 shot): ",
    recall_score(ground_truth, openchat_label),
)
print(
    "Accuracy with OpenChat 3.5 with (0 shot): ",
...
print(
    "F1-Score with zephyr beta (0 shot): ",
    f1_score(ground_truth, zephyr_label),
)
print(
    "Precision with zephyr beta (0 shot): ",
    precision_score(ground_truth, zephyr_label),
)
print(
    "Recall with zephyr beta (0 shot): ",
    recall_score(ground_truth, zephyr_label),
)
print(
    "Accuracy with zephyr beta (0 shot): ",
