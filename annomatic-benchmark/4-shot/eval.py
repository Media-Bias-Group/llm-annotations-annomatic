...
# %%
print(
    "F1-Score with Flan UL2 (4 shot): ", f1_score(ground_truth, flan_ul2_label)
)
print(
...
# %%
print(
    "F1-Score with llama 7b (4 shot): ", f1_score(ground_truth, llama_7b_label)
)
print(
...
alpha_value_with_errors = compute_krippendorff_alpha(
    df_merge_all_runs_with_errors, runs
)
alpha_value_without_errors = compute_krippendorff_alpha(
    df_merge_all_runs, runs
)
